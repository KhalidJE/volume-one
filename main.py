...
@app.get("/api/manga", operation_id="listManga")
def list_manga() -> list[Manga]:
    return manga_db

@app.post("/api/manga", status_code=201, operation_id="addManga")
...
@app.get("/api/manga/{manga_id}", operation_id="getManga")
def get_manga(manga_id: int) -> Manga:
    return find_manga(manga_id)

@app.patch("/api/manga/{manga_id}", operation_id="updateManga")
...
@app.delete("/api/manga/{manga_id}", status_code=204, operation_id="deleteManga")
